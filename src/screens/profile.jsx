        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative  mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="mx-auto relative w-[100px] sm:w-[150px] drop-shadow-2">
              ...
              <label
                htmlFor="profile"
                className="absolute bottom-0 right-0 flex h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full bg-[#ff742e] text-white hover:bg-opacity-90 sm:bottom-2 sm:right-2"
              >
                <svg
                  className="fill-current"
                  width="14"
          ...
          <div className="mt-4">
            <h3 className="mb-1.5 capitalize text-2xl font-semibold text-black dark:text-white">
              {userInfo.name}
            </h3>
